...
2. Add the resources to your Home Assistant via the UI:
   ...
   - Click **+ ADD RESOURCE** (or **+** button)
      - Enter the URL with cache busting: `/local/hockey-scoreboard-card.js?v=1.0.5`
   - Set Type to: `JavaScript Module`
   - Click **CREATE**
   - Repeat for `hockey-ticker-card.js?v=1.0.4` and `hockey-table-card.js?v=1.0.0`
...
- **Hockey Scoreboard Card**: v1.0.5
- **Hockey Ticker Card**: v1.0.4
...
#### Hockey Scoreboard Card v1.0.5
- Updated: Date format changed to full Danish format (e.g., "10. jan. kl. 19.00") for upcoming matches
